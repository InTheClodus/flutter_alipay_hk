#import "FlutterAlipayHkPlugin.h"
#import <AlipaySDK/AlipaySDK.h>

@interface FlutterAlipayHkPlugin()
...
@implementation FlutterAlipayHkPlugin
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
  FlutterMethodChannel* channel = [FlutterMethodChannel
      methodChannelWithName:@"flutter_alipay_hk"
            binaryMessenger:[registrar messenger]];
  FlutterAlipayHkPlugin* instance = [[FlutterAlipayHkPlugin alloc] init];
...
-(BOOL)handleOpenURL:(NSURL*)url{
    if ([url.host isEqualToString:@"safepay"]) {
        ...
        __weak FlutterAlipayHkPlugin* __self = self;
